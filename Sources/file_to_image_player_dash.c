...
static void	load_dash_player_2(t_minilx *mlx)
{
	mlx->sprites->player->dsh_frames[4] = mlx_xpm_file_to_image(mlx->mlx,
			"assets/sprites/Player/Dash/Dash_5.xpm",
