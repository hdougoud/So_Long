...
static void	load_portal_open(t_minilx *mlx)
{
	mlx->sprites->portal->opn_frames[0] = mlx_xpm_file_to_image(mlx->mlx,
			"assets/sprites/Portal/Open/Open_1.xpm",
